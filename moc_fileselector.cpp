...
static const char qt_meta_stringdata_FileSelector[] = {
    "FileSelector\0\0QString\0openFileDialog()\0"
};
...
void FileSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { QString _r = _t->openFileDialog();
...
const QMetaObjectExtraData FileSelector::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FileSelector::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FileSelector,
      qt_meta_data_FileSelector, &staticMetaObjectExtraData }
};
