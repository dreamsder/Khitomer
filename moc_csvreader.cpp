...
static const char qt_meta_stringdata_CsvReader[] = {
    "CsvReader\0\0QVariantList\0filePath\0"
    "readCsvFile(QString)\0"
};

void CsvReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        CsvReader *_t = static_cast<CsvReader *>(_o);
        switch (_id) {
        case 0: { QVariantList _r = _t->readCsvFile((*reinterpret_cast< const QString(*)>(_a[1])));
...
const QMetaObjectExtraData CsvReader::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CsvReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CsvReader,
      qt_meta_data_CsvReader, &staticMetaObjectExtraData }
};
