...
Rectangle {
    ...
    property string codigoDeRubroSeleccionado:"1"
    property string codigoDeSubRubroSeleccionado:"1"
    property bool orientacionSubMenu: true



    property string _codigoDeRubroSeleccionado:"1"
    property string _codigoDeSubRubroSeleccionado:"1"
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            ListView {
                ...
                model: modeloListaRubrosComboBox
                    ...
                    Rectangle{
                        ...
                        Text {
                            ...
                            Keys.onReturnPressed: {
                                ...
                                modeloListaSubRubrosComboBox.limpiarListaSubRubros()
                                modeloListaSubRubrosComboBox.buscarSubRubros(" codigoRubro=",codigoRubro)
                                _codigoDeRubroSeleccionado=codigoRubro
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            ListView {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            Keys.onReturnPressed: {
                                ...
                                codigoDeRubroSeleccionado=_codigoDeRubroSeleccionado
                                codigoDeSubRubroSeleccionado=codigoSubRubro
                                listview1.forceActiveFocus()
                                rectPrincipalComboBox.visible=false
                                txtTextoSeleccionado.text=descripcionSubRubro
                                txtTextoSeleccionado.enabled=true
                                codigoValorSeleccion=codigoSubRubro
                                cerrarComboBox()
                ...
                model: modeloListaSubRubrosComboBox
                z: 1
                focus: true
                anchors.leftMargin: 0
            }
