    ...
    Rectangle {
        ...
        MouseArea {
            ...
            ListView {
                ...
                model: modeloListaTarjetasCredito
                ...
                delegate:
                    ...
                    Rectangle{
                        ...
                        Text {
                            id: texto1
                            focus: true
                            text: descripcionTarjetaCredito
                            //
                            font.pointSize: 10
                            color:"#212121"
                            styleColor: "white"
                            ...
                            Keys.onReturnPressed: {
                                ...
                                rectPrincipalComboBox.visible=false
                                txtTextoSeleccionado.text=descripcionTarjetaCredito
                                txtTextoSeleccionado.enabled=true
                                codigoValorSeleccion=codigoTarjetaCredito
