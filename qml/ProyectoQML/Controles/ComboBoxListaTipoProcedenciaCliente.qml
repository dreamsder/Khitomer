    ...
    Rectangle {
        ...
        MouseArea {
            ...
            ListView {
                ...
                model: modeloTipoProcedenciaCliente
                ...
                delegate:
                    ...
                    Rectangle{
                        ...
                        Text {
                            id: texto1
                            focus: true
                            text: descripcionTipoProcedenciaCliente
                            //
                            font.pointSize: 10
                            color:"#212121"
                            styleColor: "white"
                            ...
                            Keys.onReturnPressed: {
                                ...
                                rectPrincipalComboBox.visible=false
                                txtTextoSeleccionado.text=descripcionTipoProcedenciaCliente
                                txtTextoSeleccionado.enabled=true
                                codigoValorSeleccion=codigoTipoProcedenciaCliente
                                enter()
