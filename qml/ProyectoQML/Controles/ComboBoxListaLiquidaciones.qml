...
Rectangle {
    ...
    property string codigoValorSeleccionExtra
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            ListView {
                ...
                model: modeloLiquidacionesComboBox
                    ...
                    Rectangle{
                        ...
                        Text {
                            ...
                            Keys.onReturnPressed: {
                                ...
                                rectPrincipalComboBox.visible=false
                                txtTextoSeleccionado.text=nombreCompletoVendedor+"-"+fechaLiquidacion
                                txtTextoSeleccionado.enabled=true
                                codigoValorSeleccion=codigoLiquidacion

                                codigoValorSeleccionExtra=codigoVendedor
