...
Rectangle {
    ...
    property string codigoValorSeleccion2
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            ListView {
                ...
                model: modeloCuentasBancariasComboBox
                ...
                delegate:
                    ...
                    Rectangle{
                        ...
                        Text {
                            id: texto1
                            focus: true
                            text: numeroCuentaBancaria+" - "+modeloListaBancos.retornaDescripcionBanco(codigoBanco)
                            smooth: true
                            font.pointSize: 10
                            font.family: "Arial"
                            color:"#212121"
                            ...
                            Keys.onReturnPressed: {
                                ...
                                rectPrincipalComboBox.visible=false
                                txtTextoSeleccionado.text=numeroCuentaBancaria+" - "+modeloListaBancos.retornaDescripcionBanco(codigoBanco)
                                txtTextoSeleccionado.enabled=true
                                codigoValorSeleccion=numeroCuentaBancaria
                                codigoValorSeleccion2=codigoBanco
