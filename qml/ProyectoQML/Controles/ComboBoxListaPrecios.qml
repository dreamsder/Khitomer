...
Rectangle {
    ...
    property alias borrarDatosVidible: imageBotonComboBoxBorrarDatos.visible
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            ListView {
                ...
                model: modeloListasPreciosComboBox
                delegate:
                    ...
                    Rectangle{
                        ...
                        Text {
                            ...
                            Keys.onReturnPressed: {
                                ...
                                rectPrincipalComboBox.visible=false
                                txtTextoSeleccionado.text=descripcionListaPrecio
                                txtTextoSeleccionado.enabled=true
                                codigoValorSeleccion=codigoListaPrecio
    ...
    Rectangle {
        ...
        TextInput {
            ...
            z: 1
            anchors.right: {
                if(imageBotonComboBoxBorrarDatos.visible){
                    imageBotonComboBoxBorrarDatos.left
                }else{
                    imageBotonComboBoxAbajo.left
                }
            }
