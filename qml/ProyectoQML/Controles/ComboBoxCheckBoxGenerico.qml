...
Rectangle {
    ...
    property string codigoUltimoClic:""
    property string tipoCodigoUltimoClic:""
    ...
    function setearMensajeDeCantidad(){
        txtTextoSeleccionado.text="Total: "+retornaCantidadItemSeleccionados()+" seleccionados"
    }

    function retornaCantidadItemSeleccionados(){
        var _contador=0;

        var totallistview1=listview1.count

        for(var i=0; i <totallistview1 ;i++ ){
    ...
    function tomarElFoco(){
        ...
        if(listview1.count>=15){
            ...
            if(listview1.count==0){
                rectPrincipalComboBox.height=listview1.contentHeight+60
            }else{
        ...
        MouseArea {
            ...
            ListView {
                ...
                delegate:
                    ...
                    Rectangle{
                        id:rect1
                        height: texto1.implicitHeight+lblTextoSegunaFila.height
                        ...
                        Text{
                            id: codigoItemAdquirido
                            visible:false
                            text: codigoItem
                        }
                        Text{
                            id: codigoTipoItemAdquirido
                            visible:false
                            text: codigoTipoItem
                        }
                        Text{
                            id: valorItemAdquirido
                            visible:false
                            text: valorItem
                        }
                        Text{
                        ...
                        Text {
                            ...
                            onActiveFocusChanged: {
                                ...
                                if(activeFocus){
                                    ...
                                    lblTextoSegunaFila.color="white"
                                    lblTextoSegunaFila.style= Text.Normal
                                    lblTextoSegunaFila.font.bold= true
                                    ...
                                    lblTextoSegunaFila.color="#212121"
                                    lblTextoSegunaFila.style= Text.Raised
                                    lblTextoSegunaFila.font.bold= false
                            ...
                            Rectangle {
                                ...
                                anchors.bottomMargin: {
                                    ...
                                    if(lblTextoSegunaFila.visible){
                                        -6 - lblTextoSegunaFila.implicitHeight
                                    }else{
                                        -3
                                    }
                            ...
                            MouseArea{
                                ...
                                height: {
                                    ...
                                    if(lblTextoSegunaFila.visible){
                                        texto1.height+lblTextoSegunaFila.height+2
                                    }else{
                                        texto1.height
                                    }
                                ...
                                onClicked: {
                                    ...
                                    //    txtTextoSeleccionado.enabled=true
                                    //   codigoValorSeleccion=codigoItem
                                    // codigoUltimoClic=modeloItems.get(index).descripcionItem;
                                    // tipoCodigoUltimoClic=modeloItems.get(index).descripcionItem;
                                    senialAlAceptarOClick()
                                }
