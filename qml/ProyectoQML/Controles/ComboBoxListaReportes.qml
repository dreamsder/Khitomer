...
Rectangle {
    ...
    property string codigoSql
    property string codigoSqlGraficas
    property string codigoSqlCabezal
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            ListView {
                ...
                model: modeloReportesMenuComboBox
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            Keys.onReturnPressed: {
                                ...
                                txtTextoSeleccionado.text=descripcionReporte
                                codigoValorSeleccion=codigoReporte
                                codigoSql=consultaSql
                                codigoSqlGraficas=consultaSqlGraficas
                                codigoSqlCabezal=consultaSqlCabezal
