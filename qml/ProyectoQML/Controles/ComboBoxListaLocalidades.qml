...
Rectangle {
    ...
    function cerrarComboBox(){
        ...
        rectPrincipalSubMenu1.visible=false
                            ...
                            MouseArea{
                                ...
                                onClicked: {
                                    ...
                                    if(rectPrincipalSubMenu.visible==false){
                                        if(listview2.count>=15){
                                            rectPrincipalSubMenu.height=400
                                            listview2.interactive=true
                                            rectPrincipalSubMenu.visible=true
                                        }else if(listview2.count==0){
                                            rectPrincipalSubMenu.height=40
                                            listview2.interactive=false
                                            rectPrincipalSubMenu.visible=false
                                            rectPrincipalSubMenu1.visible=false
                                        }else{
                                            rectPrincipalSubMenu.height=listview2.contentHeight+40
                                            listview1.interactive=false
                                            rectPrincipalSubMenu.visible=true
                                        }
                                        listview2.forceActiveFocus()
    ...
    Rectangle {
        ...
        y: 49
        width: 250
        // height: listview2.contentHeight+40
        color: "#eceeee"
        radius: 3
        anchors.top: parent.top
        ...
        MouseArea {
                        ...
                        Text {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    modeloLocalidadesComboBox.limpiarListaLocalidades()
                                    modeloLocalidadesComboBox.buscarLocalidades(" codigoPais='"+_codigoDePaisSeleccionado+"' and codigoDepartamento=",codigoDepartamento)
                                    _codigoDeDepartamentoSeleccionado=codigoDepartamento

                                    if(rectPrincipalSubMenu1.visible==false && modeloLocalidadesComboBox.rowCount()!=0){
                                        if(listview3.count>=15){
                                            rectPrincipalSubMenu1.height=320
                                            listview3.interactive=true
                                            rectPrincipalSubMenu1.visible=true
                                        }else if(listview3.count==0){
                                            rectPrincipalSubMenu1.visible=false
                                        }else{
                                            rectPrincipalSubMenu1.height=320
                                            //rectPrincipalSubMenu1.height=listview3.contentHeight+40
                                            listview3.interactive=true
                                            rectPrincipalSubMenu1.visible=true
                                        }
            ...
            Rectangle {
                ...
                Rectangle {
                    id: scrollbarItems
                    y: listview2.visibleArea.yPosition * listview2.height+3
                    height: listview2.visibleArea.heightRatio * listview2.height
                    color: "grey"
                    radius: 3
                    anchors.left: parent.left
                    anchors.leftMargin: 2
                ...
                anchors.bottom: parent.bottom
                visible: {
                    if(listview2.count==0 || !listview2.interactive){
                        false
                    }else{
                        true
                    }
    ...
    Rectangle {
        ...
        anchors.leftMargin: {
            ...
            if(orientacionSubMenu){
                ...
                (rectPrincipalSubMenu1.width*-1)+1
            }
        }
        anchors.left: rectPrincipalSubMenu.right
        Rectangle {
            id: rectSombra2
            color: "#1e646262"
            radius: 6
        ...
        MouseArea {
            ...
            ListView {
                ...
                delegate: FocusScope {
                    ...
                    Rectangle {
                        id: rect3
                        width: rectPrincipalSubMenu1.width
                        height: texto3.implicitHeight
                        color: "#00000000"
                        Text {
                            id: texto3
                            color: "#000000"
                            ...
                            Keys.onReturnPressed: {
                                ...
                                codigoDeDepartamentoSeleccionado=_codigoDeDepartamentoSeleccionado
                                codigoDeLocalidadSeleccionado=codigoLocalidad

                                rectPrincipalComboBox.visible=false
                                txtTextoSeleccionado.text=descripcionLocalidad
                                txtTextoSeleccionado.enabled=true
                                codigoValorSeleccion=codigoLocalidad
                                cerrarComboBox()
                            ...
                            MouseArea {
                                ...
                                onExited:{
                                    ...
                                    opacityOff3.start()
                                    texto3.color="#212121"
                                    texto3.style= Text.Raised
                                    texto3.font.bold= false
                ...
                model: modeloLocalidadesComboBox
                z: 1
                focus: true
                anchors.leftMargin: 0
            }
            ...
            Rectangle {
                ...
                anchors.topMargin: 30
                Rectangle {
                    id: scrollbarItemsSubMenu1
                    y: listview3.visibleArea.yPosition * listview3.height+3
                    height: listview3.visibleArea.heightRatio * listview3.height
                    color: "grey"
                    radius: 3
                    anchors.left: parent.left
                    anchors.leftMargin: 2
                ...
                anchors.bottom: parent.bottom
                visible: {
                    if(listview3.count==0 || !listview3.interactive){
                        false
                    }else{
                        true
                    }
