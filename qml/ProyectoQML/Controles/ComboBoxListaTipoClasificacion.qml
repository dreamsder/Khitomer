                ...
                delegate:
                    ...
                    Rectangle{
                        ...
                        Text {
                            id: texto1
                            focus: true
                            text: descripcionTipoClasificacion
                            //
                            font.pointSize: 10
                            color:"#212121"
                            styleColor: "white"
                            ...
                            Keys.onReturnPressed: {
                                ...
                                rectPrincipalComboBox.visible=false
                                txtTextoSeleccionado.text=descripcionTipoClasificacion
                                txtTextoSeleccionado.enabled=true
                                codigoValorSeleccion=codigoTipoClasificacion
                                enter()
