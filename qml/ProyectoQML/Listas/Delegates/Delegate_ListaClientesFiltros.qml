...
FocusScope {
    ...
    property string codigoValorSeleccionTipoCliente
    ...
    Rectangle {
        ...
        Text {
            ...
            MouseArea {
                ...
                onClicked: {
                    codigoValorSeleccion=codigoCliente
                    codigoValorSeleccionTipoCliente=codigoTipoCliente
