...
Rectangle{
    ...
    Grid {
        ...
        Text {
            ...
            text: {
                if(stockPrevisto==0){
                    "Stock previsto:  "+modeloArticulos.retornaStockTotalPrevistoArticuloOriginal(codigoArticulo)
                }else{
                    "Stock previsto:  "+stockPrevisto
                }
        ...
        Text {
            ...
            text: {
                if(stockReal==0){
                    "Stock real:  "+modeloArticulos.retornaStockTotalArticuloRealOriginal(codigoArticulo)
                }else{
