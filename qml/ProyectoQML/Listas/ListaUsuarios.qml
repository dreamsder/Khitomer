...
Rectangle{
    ...
    Text {
        id:lblUsuarios
        text: idUsuario + " - "+nombreUsuario+" "+apellidoUsuario
    ...
    MouseArea{
        ...
        onClicked: {
            ...
            txtIdUsuario.textoInputBox=idUsuario
            txtNombreUsuario.textoInputBox=nombreUsuario
            txtApellidoUsuario.textoInputBox=apellidoUsuario

            comboboxlistaperfiles1.codigoValorSeleccion=codigoPerfil
            comboboxlistaperfiles1.textoComboBox=modeloListaPerfilesComboBox.retornaDescripcionPerfil(codigoPerfil)
