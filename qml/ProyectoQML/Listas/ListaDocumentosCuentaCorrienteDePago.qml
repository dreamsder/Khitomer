...
Rectangle{
   ...
   //  width: 800
    ...
    function reclamoSeleccionado(valor){
        ...
        modeloListaDocumentoDePago.setProperty(index,"checkboxActivo",valor)
    }
        ...
        onClicked: {
            /*if ((mouse.button == Qt.LeftButton) && (mouse.modifiers & Qt.ShiftModifier)){
             ...
             /*   if(chbSeleccionado.chekActivo){
                    ...
                    modeloListaDocumentoDePago.setProperty(index,"checkboxActivo",false)
                }else{
                    chbSeleccionado.setActivo(true)
                    modeloListaDocumentoDePago.setProperty(index,"checkboxActivo",true)
                }*/
            //}
        }
