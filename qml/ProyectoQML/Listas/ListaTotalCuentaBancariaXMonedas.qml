...
Rectangle{
    ...
    property double _totalidad: parseFloat(modeloCuentasBancarias.retornaTotalXMonedaCuentaBancaria(_numeroCuentaBancaria,_codigoBancoCuentaBancaria,codigoMoneda))
